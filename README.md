...
Если нужно, могу дополнительно оформить это в `README.md` файл вместе с описанием бизнес-процесса и бизнес-правил (которые тоже явно требует docs.txt в разделе "Результат выполнения") — сделать сейчас?